...
<body>
	...
	<br>
	<br>
	<form method="POST" action="/JspApp/MomServlet?richiesta=insert">
		...
		<br>
		<br>
		<a href="/JspApp/UserServlet?richiesta=MomManager"><i class="fas fa-arrow-alt-circle-left fa-lg"> Back</i></a>
